...
var config = {
    ...
    data: {
        ...
        datasets: [{
            ...
            label: "Industry",
            type: "bar",
            backgroundColor: "rgba(11, 138, 177, 0.4)",
...
var config2 = {
    ...
    data: {
        ...
        datasets: [{
            ...
            type: "bar",
            backgroundColor: "rgba(119, 119, 121, 0.4)",
...
var config3 = {
    ...
    data: {
            ...
            
        {
            ...
            label: "Universal",
            type: "bar",
            backgroundColor: "rgba(44, 19, 114, 0.4)",
            borderColor: "rgba(44, 19, 114, 0.4)",
            borderWidth: 1,
            fill: true,
            yAxisID: 'A',
            // xAxisID: "axis-bar",
            ...
            label: "XX",
            type: "bar",
            backgroundColor: "rgba(93, 40, 240, 0.4)",
            borderColor: "rgba(44, 19, 114)",
            borderWidth: 1,
            fill: true,
            // xAxisID: "axis-bar",
            yAxisID: 'A',
...
var config4 = {
    ...
    data: {
        ...
        datasets: [{
            ...
            label: "xx",
            type: "bar",
            backgroundColor: "rgba(38, 39, 39, 0.6)",
            borderColor: "black",
            borderWidth: 1,
            fill: true,
            // xAxisID: "axis-bar",
